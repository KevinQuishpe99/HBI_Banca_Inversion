-- ============================================
-- MIGRACIÓN: assignedOnly incluye PENDING e IN_PROGRESS
-- ============================================

-- Reemplazar función get_cases_for_user para que assignedOnly considere también pasos PENDING
...
BEGIN
    IF p_user_role = 'ADMIN' THEN
        RETURN QUERY
        SELECT 
            c.id, c.case_number, c.title, c.description, c.estado,

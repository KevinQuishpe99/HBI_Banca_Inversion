/**
 * Actualiza generate_case_number() para tabla tramites / numero_tramite.
 * Uso: node database/run-migration-fix-generate-numero-tramite.js
 */
...
async function main() {
  ...
  try {
    ...
    console.log('OK: migration-fix-generate-numero-tramite aplicada.');
  } finally {
    client.release();
    await pool.end();
  }

/**
 * Corrige update_updated_at_column() para columnas actualizado_en.
 * Uso: node database/run-migration-fix-update-actualizado-en.js
 */
...
async function main() {
  ...
  try {
    const sqlPath = path.join(__dirname, 'migration-fix-update-actualizado-en.sql');
    const sql = fs.readFileSync(sqlPath, 'utf8');
    await client.query(sql);
    console.log('OK: migration-fix-update-actualizado-en aplicada.');
  } finally {
    client.release();
    await pool.end();
  }
